              ...
              <Carousel responsive={responsive} infinite={true} className="project-carousel">
                ...
                <div className="third-project">
                  ...
                  <div className="project-info-container">
                    ...
                    <div className="project-links">
                      <a href="https://github.com/dzhengg98/PM25" target="_blank" rel="noreferrer noopener"><button className="project-button">Github</button></a>
                      <a href="https://dzhengg98.github.io/PM25/" target="_blank" rel="noreferrer noopener"><button className="project-button">Live</button></a>
                    </div>
                  </div>
                </div>
              </Carousel>
